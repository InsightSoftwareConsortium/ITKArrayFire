...
/** \class Image
 *  \brief Templated n-dimensional image class that uses af::array for its
 *  pixel buffer.
 *
 * Derived from itk Image class to use with ArrayFire image filters.
 * This class manages both host and af::array memory implicitly, and
 * can be used with non-ArrayFire itk filters as well. Memory transfer
 * between host and af::array is done automatically and implicitly.
 *
